...
begin
  ...
  begin
    ShowMessage('Não existem registro para carregar na data selecionada. Verifique!');
    Exit
  end;
  ViewFortesRelVendas := TviewFortesRelVendas.Create(Self);
  ViewFortesRelVendas.lblPeriodo.Caption := 'De ' + FormatDateTime('DD/MM/YY', dtpInicial.DateTime) + ' até ' + FormatDateTime('DD/MM/YY', dtpfinal.DateTime);
